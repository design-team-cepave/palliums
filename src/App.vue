...
export default {
  ...
  data () {
    return {
      ...
      members: [
        { id: 1, title: 'members.lead.title', name: 'members.lead.name', photo: './src/assets/members/TechLead.png' },
        { id: 2, title: 'members.developer', name: 'members.developers[0]', photo: './src/assets/anonymous.jpg' },
        { id: 3, title: 'members.developer', name: 'members.developers[1]', photo: './src/assets/anonymous.jpg' },
        { id: 4, title: 'members.developer', name: 'members.developers[2]', photo: './src/assets/anonymous.jpg' },
        { id: 5, title: 'members.developer', name: 'members.developers[3]', photo: './src/assets/anonymous.jpg' },
        { id: 6, title: 'members.developer', name: 'members.developers[4]', photo: './src/assets/anonymous.jpg' },
        { id: 7, title: 'members.developer', name: 'members.developers[5]', photo: './src/assets/anonymous.jpg' },
        { id: 8, title: 'members.developer', name: 'members.developers[6]', photo: './src/assets/anonymous.jpg' },
        { id: 9, title: 'members.developer', name: 'members.developers[7]', photo: './src/assets/anonymous.jpg' },
        { id: 10, title: 'members.developer', name: 'members.developers[8]', photo: './src/assets/members/PM.jpg' },
        { id: 11, title: 'members.devOps', name: 'members.developers[9]', photo: './src/assets/anonymous.jpg' },
      ],
      questions: [
